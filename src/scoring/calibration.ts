...
/**
 * MATERIAL per exhibit, chosen from 45 real-editor calibration runs on the three slice frames.
 *
 ...
 *
 *   cctv      32  CALIBRATED  jacket 1.00 (0.87 at 40)
 *   anpr      24  CALIBRATED  car 1.00 (0.84 at 32)
 *   witness   32  CALIBRATED  car 1.00 (0.76 at 40)
 *   report    48  UNCALIBRATED  dark-target behaviour not measured; 48 is only the safe default
 *   broadcast 48  UNCALIBRATED  needs at least 48 (at 24 its untouched channel-bug seal reads 0.063),
 *                 but dark-target credit there has not been measured. Re-run the cases when item 03/04 ships.
 *
 ...
 * from an opaque one, so the brief states the rule: cover targets opaquely.
 */
